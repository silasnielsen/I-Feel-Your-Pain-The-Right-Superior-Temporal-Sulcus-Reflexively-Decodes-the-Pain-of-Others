...
if __name__ == '__main__':
    ...
    stimonset = [float(line) for line in open('onsets1.txt')]
    print stimonset    
    ...
    mywin1.close()    
    mywin=visual.Window([1280,1024],color=(-1,-1,-1),fullscr=True)
    ...
    movie=visual.MovieStim(mywin,filename='Session 1.avi',units='pix',pos=(0,0))#,size=(640,480))
    maxbar=[-.9,.9]
    bary=[-0.95,-0.85]
    ...
    fix1=visual.ShapeStim(mywin, units='pix', lineWidth=7.0, lineColor=(1.0, 1.0, 1.0),\
     lineColorSpace='rgb', fillColor=None, fillColorSpace='rgb',\
     vertices=((-20,0),(20,0)), closeShape=True,\
     pos=(0, 0), size=1, ori=0.0, opacity=0.8, depth=0,\
     interpolate=False, lineRGB=None, fillRGB=None)
    
    
    fix2=visual.ShapeStim(mywin, units='pix', lineWidth=7.0, lineColor=(1.0, 1.0, 1.0),\
     lineColorSpace='rgb', fillColor=None, fillColorSpace='rgb',\
     vertices=((0,-20),(0,20)), closeShape=True,\
     pos=(0, 0), size=1, ori=0.0, opacity=0.8, depth=0,\
     interpolate=False, lineRGB=None, fillRGB=None)
    ...
    for i in range(N):        
        ...
        while inputM.timer.timePassed()<stimonset[i+1]:
            ...
            if t>(stimonset[i]) and t<(stimonset[i]+timeStim):
                ...
                #fixation.setOri(45.)
                fix1.setLineColor((stimStrength[i],stimStrength[i],stimStrength[i]))
                fix1.setOri(45.)
                fix2.setLineColor((stimStrength[i],stimStrength[i],stimStrength[i]))
                fix2.setOri(45.)
            else:
